...
if row and (not row_tr or max(row) != max(row_tr)):
...
p_class3_va=(class3_va/len(va_list))*100 if len(va_list) > 0 else 0
p_class3_tr=(class3_tr/len(tr_list))*100 if len(tr_list) > 0 else 0
p_class1_tr=(class1_tr/len(tr_list))*100 if len(tr_list) > 0 else 0
p_class2_tr=(class2_tr/len(tr_list))*100 if len(tr_list) > 0 else 0
p_class1_va=(class1_va/len(va_list))*100 if len(va_list) > 0 else 0
p_class2_va=(class2_va/len(va_list))*100 if len(va_list) > 0 else 0
p_class1_te=(class1_te/len(te_list))*100 if len(te_list) > 0 else 0
p_class2_te=(class2_te/len(te_list))*100 if len(te_list) > 0 else 0
p_class3_te=(class3_te/len(te_list))*100 if len(te_list) > 0 else 0
p_class4_te=(class4_te/len(te_list))*100 if len(te_list) > 0 else 0
p_class4_tr=(class4_tr/len(tr_list))*100 if len(tr_list) > 0 else 0
p_class4_va=(class4_va/len(va_list))*100 if len(va_list) > 0 else 0
p_class5_te=(class5_te/len(te_list))*100 if len(te_list) > 0 else 0
p_class5_tr=(class5_tr/len(tr_list))*100 if len(tr_list) > 0 else 0
p_class5_va=(class5_va/len(va_list))*100 if len(va_list) > 0 else 0
