...
scores = {
    'Boundary-Ratio':      [0.09,  0.07 , 0.09,  0.15,       0.09, 0.06, 0.21, 0.16 , 0.12, 0.29,           0.24 ,0.05, 0.06, 0.20, 0.07, 0.02],
    'RandomForest':      [0.75, 0.30, 0.44,    0.26,      0.21,0.23 ,0.47 ,0.55 ,  0.72 ,  0.67,0.59 ,0.23 ,0.39,     0.40,0.72,0.32],
    'Bi-Directed GraphSAGE':         [0.78,  0.77, 0.47, 0.24, 0.23, 0.26, 0.58, 0.50, 0.76, 0.65, 0.49, 0.15, 0.27, 0.37, 0.50, 0.17],
}
...
# scores = {
#     'Features = 14':    [0.75, 0.78, 0.48, 0.23, 0.19, 0.24, 0.58, 0.51, 0.75, 0.65, 0.50, 0.20, 0.27, 0.33, 0.53, 0.15 ],
#     'Features = 31':   [0.75, 0.82, 0.50, 0.28,  0.22, 0.25, 0.54, 0.65, 0.78, 0.67, 0.51, 0.19, 0.30, 0.41, 0.57, 0.14],
#     'Features = 42':   [0.78,  0.77, 0.47, 0.24, 0.23, 0.26, 0.58, 0.50, 0.76, 0.65, 0.49, 0.15, 0.27, 0.37, 0.50, 0.17],

# }

# colors = {
#     'Features = 14':             '#4E79A7',  # blue
#     'Features = 31':               '#F28E2B',  # orange
#     'Features = 42':                  '#E15759',  # red
...
# scores = {
#     'Features = 14':   []
#     'Features = 31':   [0.45, 0.31, 0.26, 0.20, 0.15, 0.13, 0.38, 0.38                                                 ]
#     'Features = 42':   [0.75, 0.30, 0.44, 0.26, 0.21, 0.23 ,0.47, 0.55, 0.72, 0.67, 0.59 , 0.23, 0.39, 0.40, 0.72, 0.32]
# }
...
ax.set_ylim(0, 1.05)
# ax.set_title('Model performance for feature ablations across design families (Model: Bi-Directed GraphSAGE)', fontsize=13, fontweight='normal')
ax.set_title('Model comparision of GNN architecture and Randoom Foreat across design families', fontsize=13, fontweight='normal')
...
plt.tight_layout()
plt.savefig('results_final/training_crypto/model_comparison_gnn_rf.png', dpi=150, bbox_inches='tight')
plt.show()