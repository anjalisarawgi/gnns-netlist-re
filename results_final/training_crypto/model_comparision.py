...
# scores = {
#     'Boundary-Ratio':      [0.09,  0.07 , 0.09,  0.15,       0.09, 0.06, 0.21, 0.16 , 0.12, 0.29,           0.24 ,0.05, 0.06, 0.20, 0.07, 0.02],
#     'Features = 14':   [0.27, 0.34, 0.15, 0.15, 0.12, 0.10, 0.38, 0.30, 0.31, 0.63, 0.41, 0.08,  0.13, 0.31,  0.15, 0.08],
#     'Features = 31':   [0.45, 0.31, 0.26, 0.20, 0.15, 0.13, 0.38, 0.38, 0.45, 0.60, 0.49 , 0.10, 0.29, 0.31, 0.43, 0.12],
...
plt.tight_layout()
plt.savefig('results_final/training_crypto/final_plots/gnns_normal_bi_jk.png', dpi=150, bbox_inches='tight')
plt.show()