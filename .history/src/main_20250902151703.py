...
data = load_aisec_single_gml(gml_path="aes_key_expand_128_modified_wfeatures.gml", task_type= "aisec_bianry_classf_us00_round2")
    ...
    if task_type == "u0_inst4":
        labels = torch.tensor(task_type, dtype=torch.long)
...
if __name__ == "__main__":
    ...
    data = load_aisec_single_gml(args.gml_path, label_mode=args.label_mode)
