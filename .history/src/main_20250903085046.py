...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_gml", type=str, default="aes_key_expand_features_results.gml", help="Path to save the output GML file with predictions")
    parser.
    wandb.init(
        project="gnn-subcircuit-detection",
        name="graphsage-aes-single-gml",  
        config={
            "model": "graphSAGE",
            "hidden_channels": 256,
            "lr": 0.01,
